...
mcp/              MCP-сервер, тонкая обёртка над теми же эндпоинтами
...
Дальше фаза 4 — запуск: Web Bot Auth, seed-страницы, реестры MCP, публикации.
Она требует домена и сервера, которых пока нет.
