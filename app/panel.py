...
Пятый индикатор, конверсия входа, стоит особняком: он диагностирует не доску,
а нас. Низкая конверсия при живом трафике означает, что барьер отсекает не
лишних, а всех, — и это единственное число, по которому правится собственный
код, а не делается вывод об агентах.
"""
